read_confirmed_cases<-function(country){
  baseURL_confirmed<- paste0("https://github.com/thaispaiva/app_COVID19/blob/master/STpredictions/Brazil_",
                             country,
                             "_ne.rds?raw=true")
...
read_death_cases<-function(country){
  baseURL_deaths<- paste0("https://github.com/thaispaiva/app_COVID19/blob/master/STpredictions/Brazil_", 
                          country,
                          "_de.rds?raw=true")
